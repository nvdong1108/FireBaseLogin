package com.neotek.vandong.firebaselogin;
...
public class Login extends AppCompatActivity implements LoaderCallbacks<Cursor>, OnClickListener {
    ...
    public Button btnCreateNewAccount;
...
//            mAuthTask.execute((Void) null);
            firebaseAuth.createUserWithEmailAndPassword(email, password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(Login.this, "User or Password false", Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
    ...
    @Override
    public void onClick(View v) {
        if (v.getId() == R.id.btn_create_new_account) {
            Intent startgame = new Intent(Login.this, CreateNewAccount.class);
            startActivity(startgame);
        }
        if (v.getId() == R.id.txt_forget_password) {
            Intent startgame = new Intent(Login.this, ForgetPassword.class);
            startActivity(startgame);
        }
